...
export class OrdersController {
  ...
  @Post()
  async create(@CurrentUser() currentUser: CurrentUserContext, @Body() body: CreateOrderDto) {
  ...
  @Get()
  async list(@CurrentUser() currentUser: CurrentUserContext, @Query() query: ListOrdersDto) {
  ...
  async update(
    ...
    return this.commandBus.execute(new UpdateOrderCommand(currentUser, id, body));
  }
